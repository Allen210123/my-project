...
def evaluate(word,choose):
    ...
    data = load_files(cfg['path'].get('aftertrain_folder'), encoding='utf-8', shuffle  = False)
    split_rate = 0.8
...
# create classifier
    ...
    test_data = load_files(token_path = cfg['path'].get('aftertest_folder'), encoding='utf-8',  shuffle  = False)
